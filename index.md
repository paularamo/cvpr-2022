...
## Prework:
You should have access to an Intel Laptop. You should have basic concepts about computer vision and deep learning, such as convolutional neural networks and PyTorch and TensorFlow frameworks. 
